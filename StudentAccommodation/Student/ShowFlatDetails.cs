...
{
    public partial class ShowFlatDetails : Form
    {
        ...
        public ShowFlatDetails(string id, string stat, string fid)
        {
            InitializeComponent();
            userid = id;
            status = stat;
        ...
        public void FillDetails()
        {
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    size = ds.Tables[0].Rows[i]["size"].ToString();
        ...
        private void ShowFlatDetails_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
